CREATE DATABASE  IF NOT EXISTS `mozago_db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mozago_db`;
...
CREATE TABLE `alocacao` (
  ...
  KEY `fk_alocador_idx` (`admin`),
  KEY `fk_alocado_idx` (`director`),
  KEY `fk_obra_idx` (`obra`),
  KEY `fk_gestor_aloc_idx` (`gestor`),
  CONSTRAINT `fk_director_aloc` FOREIGN KEY (`director`) REFERENCES `usuario` (`idusuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_admin` FOREIGN KEY (`admin`) REFERENCES `usuario` (`idusuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_gestor_aloc` FOREIGN KEY (`gestor`) REFERENCES `usuario` (`idusuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `investimento` (
  ...
  `valor_invest` double DEFAULT NULL,
  `data_invest` date DEFAULT NULL,
  `descricao_invest` varchar(45) DEFAULT NULL,
  `obra_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`idinvestimento`),
  KEY `fk_obra_idx` (`obra_id`),
  CONSTRAINT `fk_obra_` FOREIGN KEY (`obra_id`) REFERENCES `obra` (`idObra`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `obra` (
  ...
  `tipo_obra` int(11) DEFAULT NULL,
  `data_inicio` date DEFAULT NULL,
  `data_fim` date DEFAULT NULL,
  `data_prazo` date DEFAULT NULL,
  `Valor_projectado` double DEFAULT NULL,
  PRIMARY KEY (`idObra`),
  KEY `fk_tipo_obra_idx` (`tipo_obra`),
  CONSTRAINT `fk_tipo_obra` FOREIGN KEY (`tipo_obra`) REFERENCES `tipo_obra` (`idtipo_obra`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipo_obra` (
  `idtipo_obra` int(11) NOT NULL AUTO_INCREMENT,
  `tipo_obra` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idtipo_obra`)
...
INSERT INTO `tipo_obra` VALUES (1,'Construção'),(2,'Reabilitação'),(3,'Expansão');
...
-- Dump completed on 2015-11-10 19:08:33
